...
#  s.vendored_frameworks = "CubiCapture.xcframework"
  s.preserve_paths = "CubiCapture.xcframework"
  s.xcconfig = {
        'FRAMEWORK_SEARCH_PATH[sdk=iphoneos*]' => '$(inherited) "$(PODS_ROOT)/CubiCapture"',
        'OTHERCFLAGS[sdk=iphoneos*]' => '$(inherited) -iframework "$(PODS_ROOT)/CubiCapture"',
        'OTHER_LDFLAGS[sdk=iphoneos*]' => '$(inherited) -framework CubiCapture'
  }
  s.platform = :ios
